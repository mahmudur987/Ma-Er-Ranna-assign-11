...
const Blogs = () => {
  return (
    <div>
      ...
      <div className="border-4 border-black p-5 m-5">
        <h1 className="font-bold text-2xl">
          Question .1 :what Difference between SQL and NoSQL ?{" "}
        </h1>
      ...
      <div className="border-4 border-black p-5 m-5">
        <h1 className="font-bold text-2xl">
          Question .3 : How does NodeJS handle multiple requests at the same
          time?{" "}
        </h1>
        <h1 className=" font-extrabold underline  text-red-600">Answer</h1>
        <p>
