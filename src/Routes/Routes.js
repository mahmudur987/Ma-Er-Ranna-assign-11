...
const routes = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: async ({ params }) => {
          return fetch(
            `https://ma-er-ranna-server.vercel.app/dishes/${params.id}`
          );
        },
      },
      {
      ...
      },
      {
        path: "*",
        element: (
          <div className="text-3xl uppercase font-bold min-h-[500px] md:text-5xl text-center my-40">
            {" "}
            <Helmet>
              <title>404</title>
            </Helmet>
            <p> this page is under maintanence</p>
          </div>
        ),
      },
    ],
