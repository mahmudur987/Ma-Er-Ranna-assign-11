...
const UserContext = ({ children }) => {
    ...
    const authinfo = { user, SetUser, signUp, login, updateUserProfile, logout, googleLogIn, githubLogIn, loading, passwordReset, SetCart, cart, theme, SetTheme, Setloading }
    return (
